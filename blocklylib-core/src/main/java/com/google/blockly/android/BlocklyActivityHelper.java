...
public class BlocklyActivityHelper {
    ...
    public BlocklyActivityHelper(AppCompatActivity activity, FragmentManager fragmentManager) {
        ...
        /* These buttons are not used anymore
    ...
    public void configureMutators() {
        Log.d("TrashCanView", "configureMutators: ");
    ...
    public void configureExtensions() {
        Log.d("TrashCanView", "configureExtensions: ");
        BlockFactory blockFactory = mController.getBlockFactory();
    ...
    public void configureCategoryFactories() {
        Log.d("TrashCanView", "configureCategoryFactories: ");
    ...
    public void showDialogFragment(@NonNull DialogFragment fragment) {
        Log.d("TrashCanView", "showDialogFragment: ");
    ...
    protected void onConfigureTrashIcon() {
        Log.d("TrashCanView", "onConfigureTrashIcon: ");
    ...
    /* We are not using these buttons anymore not deleting them in case we want to use them in the future
     *//**
    ...
    android.ut"TrashCanView.Log.d(TAG, ": ");
    ...
    *//**
    ...
    protected void onCreateVariableCallback() {
        Log.d("TrashCanView", "onCreateVariableCallback: ");
    ...
    protected void onCreateMutatorListener() {
        Log.d("TrashCanView", "onCreateMutatorListener: ");
        BlockViewFactory.MutatorToggleListener mutatorListener = new BlockViewFactory
            ...
            public void onMutatorToggled(Block block) {
                Log.d("TrashCanView", "onMutatorToggled: ");
    ...
    public void resetBlockFactory(@Nullable List<String> blockDefinitionsJsonPaths) {
        Log.d("TrashCanView", "resetBlockFactory: ");
    ...
    public void reloadToolbox(String toolboxContentsXmlPath) {
        Log.d("TrashCanView", "reloadToolbox: ");
    ...
    private void handleMutatorToggled(Block block) {
        Log.d("TrashCanView", "handleMutatorToggled: ");

...
import com.google.blockly.utils.BlockViewUtils;
...
public class BlockGroup extends NonPropagatingViewGroup {
    ...
    public void onMeasure(int widthSpec, int heightSpec) {
        ...
        try {
            ...
            layoutParams.leftMargin = BlockViewUtils.convertDpToPx(getContext(), 8);
            layoutParams.rightMargin = BlockViewUtils.convertDpToPx(getContext(), 8);
            layoutParams.topMargin = BlockViewUtils.convertDpToPx(getContext(), 4);
            layoutParams.bottomMargin = BlockViewUtils.convertDpToPx(getContext(), 4);
        } catch (Exception e) {
            e.printStackTrace();
        }

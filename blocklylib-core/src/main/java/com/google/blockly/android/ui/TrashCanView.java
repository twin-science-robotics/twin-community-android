...
public class TrashCanView extends AppCompatImageView {
    ...
    public TrashCanView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            setDefaultIcon(a.getResourceId(
                    R.styleable.TrashCanView_defaultIcon, android.R.color.transparent));
            setOnHoverIcon(a.getResourceId(
                    R.styleable.TrashCanView_onHoverIcon, R.drawable.ic_trash_open));
        } finally {
            a.recycle();
        }
    }
    ...
    public void setOnDragListener(final View.OnDragListener dragListener) {
        View.OnDragListener wrapper = new OnDragListener() {
            ...
            public boolean onDrag(View view, DragEvent dragEvent) {
                ...
                Log.d(TAG, "dragStartState" + String.valueOf(action));
    ...
    private void changeTrashState(int visible) {
        switch (visible) {
            case 0:
            case 6:
                ...
                break;
            case 1:
                setImageResource(R.drawable.ic_trash_open);
                setBackgroundColor(ContextCompat.getColor(getContext(), R.color.translucent));
                break;
            case 4:

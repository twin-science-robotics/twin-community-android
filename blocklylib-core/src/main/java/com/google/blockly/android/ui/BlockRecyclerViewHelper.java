...
public class BlockRecyclerViewHelper {
     ...
     * @param scrollOrientation {@link androidx.recyclerview.widget.OrientationHelper#HORIZONTAL} or
     * {@link androidx.recyclerview.widget.OrientationHelper#VERTICAL}.
     */
    ...
    public class Adapter extends RecyclerView.Adapter<BlockViewHolder> {
        ...
        public void onBindViewHolder(BlockViewHolder holder, int position) {
            ...
            if (item.getType() == BlocklyCategory.CategoryItem.TYPE_BLOCK) {
                ...
                LinearLayout root = (LinearLayout) mHelium.inflate(R.layout.default_create_variable_button, holder.mContainer,
                        false);
                holder.mContainer.addView(root);
                TextView tvName = (TextView) root.getChildAt(0);
                tvName.setText(bItem.getText());

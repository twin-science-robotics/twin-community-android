...
public class FlyoutFragment extends Fragment implements BlockListUI {
    ...
    public static final int DEFAULT_BLOCKS_BACKGROUND_COLOR = Color.WHITE;
    protected static final float BLOCKS_BACKGROUND_LIGHTNESS = 1f;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parent = (RelativeLayout) recyclerView.getParent();
        setTransition(LayoutTransition.APPEARING);

        parent.getLayoutTransition().addTransitionListener(new LayoutTransition.TransitionListener() {
            @Override
    ...
    public void setCurrentCategory(@NonNull BlocklyCategory category) {
        ...
        if (category == null) {
            ...
            setTransition(LayoutTransition.CHANGING);
        }
    }

    private void setTransition(int changing) {
        /*parent.getLayoutTransition()
                .setDuration(500, changing);*/
        parent.getLayoutTransition().enableTransitionType(changing);
    }
    ...
    public boolean closeUi() {
        ...
        setTransition(LayoutTransition.DISAPPEARING);
    ...
    protected void updateCategoryColors(@Nullable BlocklyCategory curCategory) {
        ...
        mFlyoutView.setBackground(ContextCompat.getDrawable(getActivity(), R.color.block_flyout_bg));
    }
    ...
    protected int getBackgroundColor(int categoryColor) {
        return ColorUtils.blendRGB(categoryColor, Color.WHITE, 1);
    }
}
